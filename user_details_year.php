...
<div class="container-fluid" id="cont-3">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <a href="user_deatils.php"><button style="margin-top:80px;" class="btn-special-2">1<sup>st</sup>Année </button></a>
            </div>
            <div class="col-md-12">
            <a href="user_details_2.php"><button style="margin-top:80px;" class="btn-special-2">2<sup>nd</sup>  Année</button></a>
            </div>
            <div class="col-md-12">
            <a href="user_details_3.php"><button style="margin-top:80px; " class="btn-special-2">3<sup>rd</sup>  Année</button></a>
            </div>
        </div>
    </div>
